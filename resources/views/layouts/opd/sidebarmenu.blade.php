<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="{{ asset('blackend/img_sk/logo.png')}}" alt=""
            class="brand-image img-circle elevation-3">

        <span class="brand-text font-weight-light">Form Pencegahan Online </span>
    </a>
        ...
        <nav class="mt-2">
            ...
            {{--  @endcan  --}}
                <li class="nav-item {{ $open_menu == 'input-laporan' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/list-form" class="nav-link {{ $active_menu == 'input_list' ? 'active' : '' }}"><i class="far fa-circle nav-icon"></i><p>Input Form Pencegahan</p></a>
                        </li>
                        <li class="nav-item">
                            <a href="/laporan-form" class="nav-link {{ $active_menu == 'laporan_list' ? 'active' : '' }}"><i class="far fa-circle nav-icon"></i><p>Laporan Form Pencegahan</p></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
